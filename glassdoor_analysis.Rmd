...
la <- read_csv("data/output_LA.csv")
la$source <- "Los Angeles"

mountview <- read_csv("data/MTV_withRating_All.csv")
mountview$source <- "Mountain View"

sf <- read_csv("data/SF_withRating_All.csv")
sf$source <- "San Francisco"

sd <- read_csv("data/San Diego.csv")
sd$source <- "San Diego"
...
wordcloud(title$word,  scale = c(5,0.5), max.word = 50, colors = brewer.pal(8, "Set1"))
...
### check for 20 models
job_text20 <- readRDS("job_text20.rds")
...
##check for 15 topics
job_text15 <- readRDS("job_text15.rds")
